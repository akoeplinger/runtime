...
try {
  ...
  const target_branch = regex.exec(comment_body)[1];
  ...
  var comment_body = `Started backporting to ${target_branch}: https://github.com/${repo_owner}/${repo_name}/actions/runs/${run_id}`;
