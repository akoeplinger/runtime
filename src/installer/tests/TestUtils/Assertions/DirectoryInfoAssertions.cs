...
namespace Microsoft.DotNet.CoreSetup.Test
{
    public class DirectoryInfoAssertions
    {
        ...
        {
            Assert.True(_dirInfo.Exists,
                $"Expected directory '{_dirInfo.FullName}' does not exist.");
            return this;
        }
